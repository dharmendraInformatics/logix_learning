...
<div class="row">
 <div class="col-md-12">
    <div class="page-box">
<form method="GET" action="<?php echo site_url('Reports'); ?>">
  <table style="width: 100%;">
    <tbody>
      <tr>
        ...
        <td width="2%"></td>
        <td width="5%">
          <a href="<?php echo site_url('Reports'); ?>"><button type="button" class="btn btn-block btn-success btn-vsm">Reset</button></a>
        </td>
      </tr>
    </tbody>
  </table>
