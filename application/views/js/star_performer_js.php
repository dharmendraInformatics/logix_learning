<script>
  $(document).ready(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Star_performer/insert_star_performer'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
      success: function(data) {
        if(data.status=='success'){
          ...
          setTimeout(function(){
            window.location = "<?php echo site_url('Star_performer'); ?>"; 
          },1000);
  ...
  $("form#frm-update").submit(function(e) { e.preventDefault();
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('Star_performer/update_star_performer'); ?>",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "JSON", 
    ...
    swal({
      ...
      if (willDelete) {
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url('Star_performer/delete_star_performer'); ?>",
