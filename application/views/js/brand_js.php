<script type="text/javascript"> 
	$(document).ready(function(e){
		$("form#frm-add").submit(function(e) { e.preventDefault();
		  ...
		  $.ajax({
		    type: "POST",
		    url: "<?php echo site_url('Master/insert_brand'); ?>",
		    data: formData,
		    processData: false,
		    contentType: false,
		    dataType: "JSON", 
		    success: function(data) {
		      if(data.status=='success'){
		        ...
		        setTimeout(function(){
		          window.location = "<?php echo site_url('Master/brand_add'); ?>"; 
		        },1000);
		...
		$("form#frm-update").submit(function(e) { e.preventDefault();
		  ...
		  $.ajax({
		    type: "POST",
		    url: "<?php echo site_url('Master/update_brand'); ?>",
		    data: formData,
		    processData: false,
		    contentType: false,
		    dataType: "JSON", 
	...
	$("#listing_tbl").on('click', '.delete-brand', function() {
	  delete_row($(this), "<?php echo site_url('Master/delete_brand'); ?>");
	});
</script>
<script>
