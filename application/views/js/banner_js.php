<script>
  $(document).ready(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Banner/insert_banner'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
      success: function(data) {
        if(data.status=='success'){
          ...
          setTimeout(function(){
            window.location = "<?php echo site_url('Banner'); ?>"; 
          },1000);
  ...
  $("form#frm-update").submit(function(e) { e.preventDefault();
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('Banner/update_banner'); ?>",
        data: formData,
        processData: false,
        contentType: false,
        dataType: "JSON", 
    ...
    swal({
      ...
      if (willDelete) {
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo site_url('Banner/delete_banner'); ?>",
