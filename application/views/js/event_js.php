<script type="text/javascript"> $(document).ready(function(e) {
  $("form#frm-add-event").submit(function(e) { e.preventDefault();
    var clkbtn = $("#btn-add-event"); clkbtn.prop('disabled',true);
    var formData = new FormData(this); 
    
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Events/insert_events'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
  ...
  $("form#frm-update").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Events/update_events'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Events/delete_events'); ?>",
