<script type="text/javascript"> $(document).ready(function(e) {
  $("form#frm-add").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Events/insert_video'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
      success: function(data) {
        if(data.status=='success'){
          ...
          setTimeout(function(){
            window.location = "<?php echo site_url('Events/videos'); ?>"; 
          },1000);
  ...
  $("form#frm-update").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Events/update_video'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Events/delete_video'); ?>",
