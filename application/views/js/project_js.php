<script type="text/javascript"> $(document).ready(function(e) {
  $("form#frm-add").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Document/insert_project'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
      success: function(data) {
        if(data.status=='success'){
          ...
          setTimeout(function(){
            window.location = "<?php echo site_url('Document/all_project'); ?>"; 
          },1000);
  ...
  $("form#frm-update").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Document/update_project'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Document/delete_project'); ?>",
