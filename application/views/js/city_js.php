<script type="text/javascript"> 
	$(document).ready(function(e){
		  ...
		  $.ajax({
		    ...
		    success: function(data) {
		      if(data.status=='success'){
		        ...
		        setTimeout(function(){
		          window.location = "<?php echo site_url('Master/city_add'); ?>"; 
		        },1000);
		...
		$("form#frm-update").submit(function(e) { e.preventDefault();
		  ...
		  $.ajax({
		    type: "POST",
		    url: "<?php echo site_url('Master/update_city'); ?>",
		    data: formData,
		    processData: false,
		    contentType: false,
		    dataType: "JSON", 
	...
	$("#listing_tbl").on('click', '.delete-city', function() {
	  delete_row($(this), "<?php echo site_url('Master/delete_city'); ?>");
	});
</script>
<script>
