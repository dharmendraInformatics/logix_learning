<script type="text/javascript"> $(document).ready(function(e) {
  $("form#frm-add").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Lab/insert_school_lab'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
  ...
  $("form#frm-update").submit(function(e) { e.preventDefault();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('Lab/update_school_lab'); ?>",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "JSON", 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Lab/delete_school_lab'); ?>",
...
<script>
  ...
  $("#lab_group").on('click',function(){

     var groupid = $(this).val();
     $.ajax({
         
         url : "<?php echo site_url('Lab/get_group_type') ?>",
         dataType : "JSON",
