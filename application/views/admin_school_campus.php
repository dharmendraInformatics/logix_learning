      ...
      <div class="breadcromb-area">
         <div class="row">
            ...
            <div class="col-md-10 col-sm-10">
              <a href="<?php echo site_url('Campus/add_school_campus') ?>" class="btn btn-info pull-right">Add  Campus</a>
            </div>
         </div>
      </div>
   </div>
        ...
        <table id="my_tbl" class="my_custom_datatable table table-striped table-bordered">
          ...
          if(!empty($all_value)){
            foreach($all_value as $value){
              $edit_link = site_url('Campus/edit_school_campus?id=');
              
              if(!empty($value->campus_image)){
                $image_link = base_url('uploads/Campus/').$value->campus_image;
              }
              else{
            ...
            <tr>
              ...
              <td title="Title"><?php echo $value->campus_title; ?></td>
              <td title="Image"><a href="<?php echo $image_link;?>" class="btn btn-danger" target="_blank"><i class="fa fa-picture-o"></i> Image</a></td>
              <td title="Description">
                <input type="hidden" id="m_cal_desc<?php echo $value->campus_id  ;?>" value="<?php echo $value->campus_desc;?>">
                <button class="btn btn-info" onclick="viewDetails(<?php echo $value->campus_id;?>)"><i class="fa fa-eye"></i> Description</button>
              </td>
              <td title="" style="white-space: nowrap;">
              <a href="<?php echo $edit_link.$value->campus_id ; ?>" class="btn btn-success btn-action" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a> 
              <button class="btn btn-danger btn-action delete-data" data-value="<?php echo $value->campus_id ; ?>" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></button>
              </td>
            </tr>
            <?php
            $i++;
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Campus Description</h4>
          </div>
...
<!-- ========================Script========================== -->
<?php $this->view('js/school_campus_js'); $this->view('js/custom_js');?>
<!-- ========================Script========================== -->