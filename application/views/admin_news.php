      ...
      <div class="breadcromb-area">
         <div class="row">
            ...
            <div class="col-md-10 col-sm-10">
              <a href="<?php echo site_url('News/add_news') ?>" class="btn btn-info pull-right">Add News</a>
            </div>
         </div>
      </div>
   </div>
        ...
        <table id="my_tbl" class="my_custom_datatable table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th title="Posted On">Posted On</th>
          ...
          if(!empty($all_value)){
            foreach($all_value as $value){
              $edit_link = site_url('News/edit_news?id=');
              if($value->m_news_type==1)
                $news_type='News';
              else
                $news_type='Notice';

              if(!empty($value->m_news_image)){
                $image_link = base_url('uploads/news/').$value->m_news_image;
              }
              else{
            ...
            <tr>
              ...
              <td title="Title"><?php echo $news_type; ?></td>
              <td title="Title"><?php echo $value->m_news_title; ?></td>
              <td title="PDF"><a href="<?php echo $image_link;?>" class="btn btn-info" target="_blank"><i class="fa fa-picture-o"></i> Image</a></td>
              <td title="Description">
                <input type="hidden" id="news_desc<?php echo $value->m_news_id;?>" value="<?php echo $value->m_news_desc;?>">
                <button class="btn btn-info" onclick="viewDetails(<?php echo $value->m_news_id;?>)"><i class="fa fa-eye"></i> Description</button>
              </td>
              <td title="Title"><?php echo date('d-m-Y',strtotime($value->m_news_posted)); ?></td>
              <td title="" style="white-space: nowrap;">
                <a href="<?php echo $edit_link.$value->m_news_id ; ?>" class="btn btn-success btn-action" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a> 
                <button class="btn btn-danger btn-action delete-data" data-value="<?php echo $value->m_news_id ; ?>" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></button>
              </td>
            </tr>
            <?php
            $i++;
          ...
          <!-- <form class="formdata" id="formdata" novalidate="" method= "post" action="<?php echo base_url('Corporate/reply_msg');?>"> -->
              <div class="modal-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="news_descr" name ="news_descr" style="height: 140px !important;"></textarea>
                </div>
              </div>
...
<!-- ========================Script========================== -->
<?php $this->view('js/news_js');  $this->view('js/custom_js'); ?>
<!-- ========================Script========================== -->