                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="performer_name" id="performer_name" class="form-control"  placeholder="Performer Name" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Performer Contact <span class="req">*</span></label>
                      <input type="text" name="performer_contact" id="performer_contact" class="form-control"  placeholder="Performer Contact" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Image</label>
                    <input type="file" name="performer_image" id="performer_image" class="form-control" required="">
                    </div>
                  </div>
              </div>
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea name="performer_desc" id="performer_desc" class="form-control" value="" placeholder="Description"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-layout-submit">
                  <button type="submit" id="btn-add" class="btn btn-block btn-info">Add Performer</button>
                </div>
              </div>
              <div class="col-md-6">
