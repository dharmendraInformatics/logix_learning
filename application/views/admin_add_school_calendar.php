            ...
            <div class="form-wrap top-label-exapmple form-layout-page">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="m_cal_title" id="m_cal_title" class="form-control"  placeholder="Title" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Date <span class="req">*</span></label>
                      <input type="date" name="m_cal_date" id="m_cal_date" class="form-control"  placeholder="Title" required="" value="<?php echo date('Y-m-d');?>">
                    </div>
                  </div>
                   <div class="col-md-4">
                    <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-8">
                    ...
                    <input type="file" name="m_cal_pdf" id="m_cal_pdf" class="form-control" required="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea name="m_cal_desc" id="m_cal_desc" class="form-control" value="" placeholder="Description"></textarea>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-layout-submit">
                  <button type="submit" id="btn-add" class="btn btn-block btn-info">Add Calendar</button>
                </div>
              </div>
              <div class="col-md-6">
