      ...
      <div class="breadcromb-area">
         <div class="row">
            ...
            <div class="col-md-10 col-sm-10">
              <a href="<?php echo site_url('Academic/add_academic') ?>" class="btn btn-info pull-right">Add Academic</a>
            </div>
         </div>
      </div>
   </div>
        ...
        <table id="my_tbl" class="my_custom_datatable table table-striped table-bordered">
          ...
          if(!empty($all_value)){
            foreach($all_value as $value){
              $edit_link = site_url('Academic/edit_academic?id=');
              if($value->academic_type ==1)
                $doc_type='Student Report';
              else if($value->academic_type ==2)
                $doc_type='Result';
              else
                $doc_type='Achivement';
              if(!empty($value->academic_file)){
                $image_link = base_url('uploads/reports/').$value->academic_file;
              }
              else{
            ...
            <tr>
              ...
              <td title="Document Title"><?php echo $value->academic_title; ?></td>
              <td title="PDF"><a href="<?php echo $image_link;?>" class="btn btn-danger" target="_blank"><i class="fa fa-file-pdf-o"></i> PDF</a></td>
              <td title="Description">
                <input type="hidden" id="m_academic_desc<?php echo $value->academic_id;?>" value="<?php echo $value->academic_desc;?>">
                <button class="btn btn-info" onclick="viewDetails(<?php echo $value->academic_id;?>)"><i class="fa fa-eye"></i> Description</button>
              </td>
            <td title="" style="white-space: nowrap;">
              <a href="<?php echo $edit_link.$value->academic_id ; ?>" class="btn btn-success btn-action" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a> 
              <button class="btn btn-danger btn-action delete-data" data-value="<?php echo $value->academic_id ; ?>" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></button>
            </td>
            </tr>
            <?php
            $i++;
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Academic Description</h4>
          </div>
          <!-- <form class="formdata" id="formdata" novalidate="" method= "post" action="<?php echo base_url('Corporate/reply_msg');?>"> -->
              <div class="modal-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="academic_desc" name ="academic_desc" style="height: 140px !important;"></textarea>
                </div>
              </div>
...
<!-- ========================Script========================== -->
<?php $this->view('js/academic_js'); $this->view('js/custom_js'); ?>
<!-- ========================Script========================== -->