            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <select name="mm_brand_id" id="mm_brand_id" class="form-control">
                  ...
                  <?php if(!empty($brand)){ foreach($brand as $bdl){ echo "<option value='".$bdl->m_brand_id."'>".$bdl->m_brand_name."</option>"; } } ?></select>
                 </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label>Model Name</label>
                  <input type="text" name="m_model_name" id="m_model_name" class="form-control" placeholder="Model Name" autofocus="true">
                </div>
              </div>
            </div>
            <div class="row">
