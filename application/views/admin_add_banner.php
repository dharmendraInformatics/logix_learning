                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="m_banner_title" id="m_banner_title" class="form-control"  placeholder="Title" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Image(1920px x 445px) <span class="req">*</span></label>
                    <input type="file" name="m_banner_image" id="m_banner_image" class="form-control" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Order </label>
                      <input type="number" name="m_banner_order" id="m_banner_order" class="form-control"  placeholder="Order">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-layout-submit">
                  <button type="submit" id="btn-add" class="btn btn-block btn-info">Add Banner</button>
                </div>
              </div>
              <div class="col-md-6">
