            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="m_dealer_name" id="m_dealer_name" class="form-control" placeholder="Name" autofocus="true">
                </div>
                <div class="form-group">
                  <label>Contact</label>
                  <input type="number" name="m_dealer_contact" id="m_dealer_contact" class="form-control" placeholder="Contact" autofocus="true">
                </div>
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="m_dealer_email" id="m_dealer_email" class="form-control" placeholder="Email" autofocus="true">
                </div>
                <div class="form-group">
                  <label>City</label>
                  <select name="m_dealer_city" id="m_dealer_city" class="form-control select2">
                    <option value="">--- Select City ---</option>
                    <?php if(!empty($city)){ foreach($city as $ct){ echo "<option value='".$ct->m_city_id."'>".$ct->m_city_name."</option>"; } } ?></select>
                </div>
                <div class="form-group">
                  <textarea class="form-control" placeholder="Address" name="m_dealer_address" id="m_dealer_address"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
