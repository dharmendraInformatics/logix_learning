          ...
          <div class="form-example">
            <div class="form-wrap top-label-exapmple form-layout-page">
              <form method="post" action="#" id="frm-update">
                <input type="hidden" name="m_project_id" value="<?php echo $a_value[0]->m_project_id;?>">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>प्रोजेक्ट नाम<span class="req">*</span></label>
                      <input type="text" name="m_project_name" id="m_project_name" class="form-control"  placeholder="प्रोजेक्ट नाम" value="<?php echo $a_value[0]->m_project_name;?>" required="">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>प्रोजेक्ट कोड</label>
                      <input type="text" name="m_project_code" id="m_project_code" class="form-control"  placeholder="प्रोजेक्ट कोड" value="<?php echo $a_value[0]->m_project_code;?>" required=""> 
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>प्रोजेक्ट इंजीनियर<span class="req">*</span></label>
                      <input type="text" name="m_project_engineer" id="m_project_engineer" class="form-control"  placeholder="प्रोजेक्ट इंजीनियर" value="<?php echo $a_value[0]->m_project_engineer;?>" required="">
                    </div>
                  </div>
              </div>
            <hr>
            <div class="row">
              <div class="col-md-6">
                <div class="form-layout-submit">
                  <button type="submit" id="btn-update" class="btn btn-block btn-info">अपडेट करें</button>
                </div>
              </div>
              <div class="col-md-6">
