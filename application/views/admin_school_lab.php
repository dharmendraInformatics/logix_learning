      ...
      <div class="breadcromb-area">
         <div class="row">
            ...
            <div class="col-md-10 col-sm-10">
              <a href="<?php echo site_url('Lab/add_school_lab') ?>" class="btn btn-info pull-right">Add  Infrastructure</a>
            </div>
         </div>
      </div>
   </div>
        ...
        <table id="my_tbl" class="my_custom_datatable table table-striped table-bordered">
          ...
          if(!empty($all_value)){
            foreach($all_value as $value){
              $edit_link = site_url('Lab/edit_school_lab?id=');
              
              if(!empty($value->lab_image)){
                $image_link = base_url('uploads/lab/').$value->lab_image;
              }
              else{
            ...
            <tr>
              ...
              <td title="Title"><?php echo $value->lab_title; ?></td>
              <td title="Title"><?php echo $value->group_title; ?></td>
              <td title="Title"><?php echo ($value->l_type_name != ''?$value->l_type_name:'N/A'); ?></td>
              <td title="Image"><a href="<?php echo $image_link;?>" class="btn btn-danger" target="_blank"><i class="fa fa-picture-o"></i> Image</a></td>
              <td title="Description">
                <input type="hidden" id="m_cal_desc<?php echo $value->lab_id ;?>" value="<?php echo $value->lab_desc;?>">
                <button class="btn btn-info" onclick="viewDetails(<?php echo $value->lab_id;?>)"><i class="fa fa-eye"></i> Description</button>
              </td>
              <td title="" style="white-space: nowrap;">
              <a href="<?php echo $edit_link.$value->lab_id ; ?>" class="btn btn-success btn-action" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a> 
              <button class="btn btn-danger btn-action delete-data" data-value="<?php echo $value->lab_id ; ?>" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></button>
              </td>
            </tr>
            <?php
            $i++;
...
<!-- ========================Script========================== -->
<?php $this->view('js/school_lab_js'); $this->view('js/custom_js');?>
<!-- ========================Script========================== -->